...
- [Git Status](https://starship.rs/config/#git-status)—it took me a while to get used to the meanings of the icons, but it was worth it; my "g", "s" and "t" keys have seen their usage plummet
